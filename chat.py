...
def messages_txt():
    with open('messages_list.txt', 'w') as arquivo:
        for item in confirmed_messages:
    ...
    while True:
        ...
        try:
            if message_text != "exit":
                for i in range(1, 100):  # Envia  mensagens sequenciais
...
def main():
    ...
    try:
            ...
            while True:
                ...
                print("[3] Para acionar o bot de teste")
                print("[4] Para salvar a lista em .txt")
                print("[5] Para sair")
